...
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][The lattice after the vertical bonds moving step and after the sum of the spin represented in red.]{\includegraphics[width=0.8\textwidth]{../lessons/20_image/15.pdf}  \label{fig:20_12_2} }
\end{minipage}
