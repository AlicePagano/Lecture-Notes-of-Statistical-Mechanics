...
\begin{enumerate}
\item Firstly, we move the vertical bonds and double the ones that will survive, as in Figure \ref{fig:20_12_1}.
...
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Description]{\includegraphics[width=0.8\textwidth]{../lessons/20_image/15.pdf}  \label{fig:20_12_2} }
\end{minipage}
\caption{\label{fig:20_12} Description}
\end{figure}



 We can now perform the sum of the spins, represented as a red cross in the figure, along the \( x \) direction as for the case \( d=1 \).
This gives
\begin{equation*}
...
\item We finally perform the sum of the red cross spins along the \( y \) direction.
We obtain:
\begin{equation*}
