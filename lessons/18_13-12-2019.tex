...
\begin{equation}
  \widetilde{Z} _{GL}^{T>T_c} =  \int_{- \infty }^{+ \infty }  \qty( \prod_{\va{k}}'  \dd[]{\varphi _{\va{k}}})
...
Let us consider again the case \( T>T_c \) (for which we have \( (m_0=0) \)) and \( h=0 \). The partition function of the system in the Fourier space is the one in Eq.\eqref{eq:18_9}:
\begin{equation}
