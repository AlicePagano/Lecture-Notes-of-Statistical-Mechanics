...
\begin{split}
  ...
  & -\mathcolorbox{yellow!40}{ \lambda v^2 \delta \Phi _1 ^2} + \mathcolorbox{green!20}{q^2 v^2 A_{\mu } A ^{\mu }} - \mathcolorbox{red!20}{q v A ^{\mu } \partial_ \mu \delta \Phi _2} + \text{higher order terms}
\end{split}
\end{equation}
