...
\subfloat[][Original system.]{ \includegraphics[width=0.8\textwidth]{../lessons/19_image/2.png}  \label{fig:} }
\end{minipage}
\begin{minipage}[]{0.32\linewidth}
\centering
\subfloat[][Block spins.]{\includegraphics[width=0.8\textwidth]{../lessons/19_image/3.png}  \label{fig:} }
\end{minipage}
\begin{minipage}[]{0.32\linewidth}
\centering
\subfloat[][Final rescaled system.]{\includegraphics[width=0.8\textwidth]{../lessons/19_image/4.png}  \label{fig:} }
\end{minipage}
