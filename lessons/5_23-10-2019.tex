...
\includegraphics[width=0.8\textwidth]{../lessons/4_image/2.pdf}
    \label{fig:5_1_0} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Magnetic system with characteristic length \emph{L}.]{
\includegraphics[width=0.5\textwidth]{../lessons/4_image/3.pdf}
    \label{fig:5_1_1} }
\end{minipage}
\caption{\label{fig:} }
\end{figure}
...
\begin{equation*}
  t \sim (10^{10})^{-2 } = 10^{-20}
\end{equation*}
Therefore we have \( t \approx 10^{-20} \)  as a distance from \( T_c \).
