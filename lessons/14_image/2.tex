...
\draw    (113.5,35) .. controls (136,88) and (148.5,110) .. (199.5,122) .. controls (247.5,133) and (277.5,174) .. (290.5,197) ;


%Curve Lines [id:da2848143995073411] 
\draw    (89.5,37) .. controls (93.5,78) and (90.5,197) .. (130.5,167) .. controls (170.5,137) and (169.5,140) .. (182.5,141) .. controls (195.5,142) and (260.5,210) .. (277.5,216) ;


%Curve Lines [id:da802724207727525] 
\draw    (147.5,34) .. controls (185.5,90) and (235.5,118) .. (314.5,145) ;
...
% Text Node
\draw (319,108) node   {$T\  >\ T_{c}$};
% Text Node
\draw (321,170) node   {$T\ =\ T_{c}$};
