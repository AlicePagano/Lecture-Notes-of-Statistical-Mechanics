...
\subfloat[][Square lattice. We sum over the red cross spins.]{ \includegraphics[width=0.8\textwidth]{./img/7.pdf}  \label{fig:20_7_1} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][New interactions introduced.]{\includegraphics[width=0.8\textwidth]{./img/8.pdf}  \label{fig:20_7_2} }
\end{minipage}
...
\begin{figure}[H]
\begin{minipage}[c]{0.5\linewidth}
\subfloat[][The original lattice. Some bonds are moved to neighbouring ones.]{ \includegraphics[width=0.8\textwidth]{./img/11.pdf}  \label{fig:} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][The lattice after the bonds moving step. The double bonds have coupling constant \( K \rightarrow 2K \). ]{\includegraphics[width=0.8\textwidth]{./img/12.pdf}  \label{fig:} }
\end{minipage}
...
\begin{figure}[H]
\begin{minipage}[c]{0.5\linewidth}
\subfloat[][The lattice after the vertical bonds moving step.]{ \includegraphics[width=0.8\textwidth]{./img/14.pdf}  \label{fig:20_12_1} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][The lattice after the vertical bonds moving step and after the sum of the spin along \( x \).]{\includegraphics[width=0.8\textwidth]{./img/15.pdf}  \label{fig:20_12_2} }
\end{minipage}
