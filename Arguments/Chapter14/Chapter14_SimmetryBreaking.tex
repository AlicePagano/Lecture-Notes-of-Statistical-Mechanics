...
% Search for !!CHECK!! to find the problems
\begin{document}
...
\subfloat[][Plot of the potential \( V (\Phi ) \) in the case \( r_0 > 0 \), i.e. \( T>T_c \).]{ \includegraphics[width=0.8\textwidth]{./img/1.pdf}  \label{fig:n_5} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Plot of the potential \( V (\Phi ) \) in the case \( r_0 < 0 \), i.e. \( T<T_c \).]{\includegraphics[width=0.8\textwidth]{./img/2.pdf}  \label{fig:n_6} }
\end{minipage}
\caption{\label{fig:} }
\end{figure}
...
\begin{figure}[H]
\begin{minipage}[c]{0.5\linewidth}
\subfloat[][Feyman diagram of the term \( \propto \delta \Phi _1 A_ \mu A ^ \mu  \). ]{ \includegraphics[width=0.8\textwidth]{./img/5.pdf}  \label{fig:n_7} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Feyman diagram of the term \( \propto \delta \Phi _1 ^2 A _ \mu A ^ \mu  \).]{\includegraphics[width=0.8\textwidth]{./img/6.pdf}  \label{fig:n_8} }
\end{minipage}
\caption{\label{fig:} }
\end{figure}
